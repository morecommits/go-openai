...
[![Go Reference](https://pkg.go.dev/badge/github.com/morecommits/go-openai.svg)](https://pkg.go.dev/github.com/morecommits/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/morecommits/go-openai)](https://goreportcard.com/report/github.com/morecommits/go-openai)
[![codecov](https://codecov.io/gh/morecommits/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/morecommits/go-openai)
...
```
go get github.com/morecommits/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/morecommits/go-openai"
)
...
See also: https://pkg.go.dev/github.com/morecommits/go-openai#ClientConfig
...
import (
	...
	"github.com/morecommits/go-openai"
)
...
import (
	...
	"github.com/morecommits/go-openai"
	"github.com/morecommits/go-openai/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/morecommits/go-openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/morecommits/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/morecommits/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/morecommits/go-openai/graphs/contributors) and sponsors of this project:
